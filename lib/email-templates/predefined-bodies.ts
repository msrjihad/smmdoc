/**
 * Predefined email template bodies.
 * These serve as fallback when the database is empty or unavailable.
 * Run `npm run export-email-templates` to sync from database.
 */
