...
const AnalyticsInjector = () => {
  ...
  useEffect(() => {
    ...
    if (analyticsSettings.googleAnalytics.enabled &&
      ...
      const existingGAScripts = document.querySelectorAll('script[src*="google-analytics.com"], script[src*="googletagmanager.com/gtag"], script[data-analytics="ga"]');
      ...
      if ((gaCode.includes('<script') || gaCode.includes('ga(') || gaCode.includes('google-analytics.com/analytics.js')) &&
          !gaCode.includes('gtag') && !gaCode.includes('googletagmanager.com/gtag')) {
        ...
        const isUA = /^UA-\d+-\d+$/.test(trackingId);
    ...
    if (analyticsSettings.gtm.enabled &&
      ...
      const existingGTMScripts = document.querySelectorAll('script[data-analytics="gtag"], noscript[data-analytics="gtag"]');
      ...
      if (gtmCode.includes('<script') || gtmCode.includes('gtm.js') || gtmCode.includes('dataLayer')) {
        ...
        scripts.forEach((script, index) => {
          const newScript = document.createElement('script');
          newScript.setAttribute('data-analytics', 'gtag');
        ...
        noscripts.forEach((noscript, index) => {
          const newNoscript = document.createElement('noscript');
          newNoscript.setAttribute('data-analytics', 'gtag');
          newNoscript.innerHTML = noscript.innerHTML;
        ...
        gtmScript.setAttribute('data-analytics', 'gtag');
        gtmScript.innerHTML = `
        ...
        gtmNoscript.setAttribute('data-analytics', 'gtag');
