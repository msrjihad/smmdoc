...
export default function ApiIntegrationPage() {
  ...
  const [apiSpecData, setApiSpecData] = useState<{
    baseUrl: string;
    httpMethod: string;
  ...
  useEffect(() => {
    const fetchApiSpec = async () => {
      try {
        const res = await fetch('/api/public/api-documentation-spec');
        const result = await res.json();
        if (result.success && result.data) {
          setApiSpecData(result.data);
        }
      } catch (error) {
  ...
  const serviceTypes = apiSpecData?.serviceTypes || defaultServiceTypes;
  const spec = apiSpecData?.spec || {
    apiKeyParam: 'key',
    actionParam: 'action',
  ...
  const apiBaseUrl = apiSpecData?.baseUrl || (typeof window !== 'undefined' ? `${window.location.origin}/api` : '');
  const httpMethod = apiSpecData?.httpMethod || 'POST';
...
$url = '${apiBaseUrl || 'https://yoursite.com/api/v2'}';

$apiKey = '${apiKey || 'YOUR_API_KEY'}';

$postData = [
    '${spec.apiKeyParam}' => $apiKey,
    '${spec.actionParam}' => '${spec.addOrderAction}',
    '${spec.serviceIdParam}' => 1,
    '${spec.linkParam}' => 'https://www.instagram.com/username',
    '${spec.quantityParam}' => 100
];
...
const url = '${apiBaseUrl || 'https://yoursite.com/api/v2'}';
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">{httpMethod}</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">API URL</h4>
                  <div className="flex items-center gap-2">
                    <p className="text-gray-600 dark:text-gray-300 font-mono text-sm break-all flex-1">
                      {apiBaseUrl || 'Loading...'}
                    </p>
                    {apiBaseUrl && (
                      <button
                        onClick={() => copyToClipboard(apiBaseUrl, 'API URL copied to clipboard')}
                ...
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.apiKeyParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
                        Your API key
                      </td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.actionParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
                        {spec.servicesAction}
                      </td>
                    </tr>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.orderIdParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
                        Order ID
                      </td>
                    </tr>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.ordersParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
                ...
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.actionParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
                        {spec.refillStatusAction}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.refillIdParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
                        Refill ID
                      </td>
                    </tr>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[var(--card-bg)]">
                      <td className="py-3 px-4 font-mono text-sm text-gray-900 dark:text-gray-100">{spec.refillsParam}</td>
                      <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-300">
