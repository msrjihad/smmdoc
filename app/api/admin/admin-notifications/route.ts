  ...
  try {
    ...
    await db.integrationSettings.upsert({
      ...
      update: {
        ...
        adminNotifNewManualRefillRequests: adminNotifications.refillRequestsEnabled ?? false,
        adminNotifNewManualCancelRequests: adminNotifications.cancelRequestsEnabled ?? false,
        ...
        adminNotifAnnouncement: adminNotifications.announcementEnabled ?? false,
        updatedAt: new Date(),
      },
      create: {
        id: 1,
